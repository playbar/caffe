 ...
 public:
  ...
  ~MessageLogger() {
    ...
    static const int android_log_levels[] = {
        ...
        ANDROID_LOG_ERRORLOG,    // LOG(ERRORLOG)
    ...
    char buffer [20];
    strftime(buffer, 80, "%m-%d %H:%M:%S", localtime((time_t*)&curTime.tv_sec));
    char time_cstr[24] = "";
    ...
    } else if (severity_ == ERRORLOG) {
        // Red color if ERRORLOG
